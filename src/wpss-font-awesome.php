...
/**
 * Plugin Name: WPS Scripts - Font Awesome for WordPress
...
if ( class_exists( 'WPS_Scripts' ) ) {
	require_once( 'lib/classes/font-awesome.php' );
}

if ( class_exists( 'WPSS_Font_Awesome' ) ) {
	$_wpss_font_awesome = new WPSS_Font_Awesome();
}